# -*- coding: utf-8 -*-
"""
Created on Thu Dec 14 11:26:43 2023
...
# MAKE HERE THE REFRESSION MODEL
from sklearn.neighbors import KNeighborsClassifier
classifier = KNeighborsClassifier(n_neighbors=5, metric='minkowski', p=2)#Euclidian distance p =2
# Euclidean distance is not linear
classifier.fit(X_train,y_train)

# PREDICTION OF OWN REGRESSION MODEL
y_pred = classifier.predict(X_test) # not always right
